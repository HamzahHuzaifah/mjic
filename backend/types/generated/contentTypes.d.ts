...
export interface ApiGaleriGaleri extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Galeri Foto Kegiatan dan Fasilitas';
    displayName: 'Galeri';
    pluralName: 'galeris';
    singularName: 'galeri';
  };
  ...
  attributes: {
    ...
    Kategori: Schema.Attribute.Enumeration<
      ['PAUDQu', 'TPQ', 'MDT', 'Fasilitas', 'Kegiatan']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Kegiatan'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::galeri.galeri'
...
export interface ApiGuruGuru extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Data Tenaga Pendidik dan Kependidikan';
    displayName: 'Guru';
    pluralName: 'gurus';
    singularName: 'guru';
  };
...
export interface ApiProfilMadrasahProfilMadrasah
  extends Struct.SingleTypeSchema {
  collectionName: 'profil_madrasahs';
  info: {
    description: 'Informasi Utama Profil Madrasah';
    displayName: 'Profil_Madrasah';
    pluralName: 'profil-madrasahs';
    singularName: 'profil-madrasah';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::profil-madrasah.profil-madrasah'
    > &
      Schema.Attribute.Private;
    Misi: Schema.Attribute.RichText & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    Sambutan_Kepsek: Schema.Attribute.RichText & Schema.Attribute.Required;
    Sejarah: Schema.Attribute.RichText & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Visi: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::profil-madrasah.profil-madrasah': ApiProfilMadrasahProfilMadrasah;
